    ...
    <div class="bg-gray-50">
      <div class="relative overflow-hidden">
        ...
        <div class="relative pt-6 pb-16 sm:pb-24">
          <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <nav class="relative w-full flex items-center justify-between sm:h-10" aria-label="Global">
              <div class="flex items-center ">
                <div class="flex items-center justify-between w-full md:w-auto">
                  <a href="#">
                    <span class="font-black	text-2xl text-gray-900">Emerald</span>
                  </a>
                </div>
              </div>
          ...
          <div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
            <div class="text-center">
              <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span class="block">Website under maintenance</span>
        ...
        <div class="relative">
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <img class="relative rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1557827983-012eb6ea8dc1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2255&q=80" alt="App screenshot">
          </div>
        </div>
      </div>
      ...
      <!-- <div class="bg-gray-800">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <h2 class="text-center text-gray-400 text-sm font-semibold uppercase tracking-wide">Trusted by over 4600 forward-thinking companies</h2>
    ...
    <!-- <div class="bg-white">
      <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        <div class="max-w-3xl mx-auto text-center">
          <h2 class="text-3xl font-extrabold text-gray-900">Our Servises</h2>
          <p class="mt-4 text-lg text-gray-500"></p>
        </div>
        <dl class="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-1 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-3 lg:gap-x-8">
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <dd class="mt-2 text-base text-gray-500">
                Working with major global producers but at the same time, responding to our environmental responsibilities by seeking alternative products and materials in order to meet the varying demands of our customers.
              </dd>
            </div>
          </div>
          ...
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <dd class="mt-2 text-base text-gray-500">
                Active analyses in our labs Providing of all the technical documents and health certificates New product research and development consultancy
              </dd>
            </div>
          </div>
          ...
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <dd class="mt-2 text-base text-gray-500">
                Emerald laboratories provide testing services for a broad range of clients, markets and industries.
              </dd>
            </div>
          </div>
        </dl>
